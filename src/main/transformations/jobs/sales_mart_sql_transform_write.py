...
# Find out the total sales done by each sales_person every month and write the data into MySQL table
# If found any error with date column refer customer_mart_sql_transform_write.py file
